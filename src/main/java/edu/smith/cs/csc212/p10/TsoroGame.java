...
public class TsoroGame extends GFX {
	...
	public List<TsoroCell> neighbors0 = new ArrayList<>();

	public List<TsoroCell> neighbors1 = new ArrayList<>();

	public List<TsoroCell> neighbors2 = new ArrayList<>();

	public List<TsoroCell> neighbors3 = new ArrayList<>();

	public List<TsoroCell> neighbors4 = new ArrayList<>();

	public List<TsoroCell> neighbors5 = new ArrayList<>();

	public List<TsoroCell> neighbors6 = new ArrayList<>();
...
//		p1Tokens-=1;
		List<TsoroCell> midRow = Arrays.asList(this.grid.get(1).get(1), this.grid.get(2).get(2),
				this.grid.get(3).get(3));
		if (allMarked(midRow, TMark.Player1)) {
			return true;
		}
		List<TsoroCell> botRow = Arrays.asList(this.grid.get(4).get(4), this.grid.get(5).get(5),
				this.grid.get(6).get(6));
		if (allMarked(botRow, TMark.Player1)) {
			return true;
		}

		List<TsoroCell> leftRightD = Arrays.asList(this.grid.get(0).get(0), this.grid.get(1).get(1),
				this.grid.get(4).get(4));
		if (allMarked(leftRightD, TMark.Player1)) {
			return true;
		}
		List<TsoroCell> rightLeftD = Arrays.asList(this.grid.get(0).get(0), this.grid.get(3).get(3),
				this.grid.get(6).get(6));
		if (allMarked(rightLeftD, TMark.Player1)) {
			return true;
		}
		List<TsoroCell> verticalD = Arrays.asList(this.grid.get(0).get(0), this.grid.get(2).get(2),
...
//		for (int x = 0; x < 8; x++) {
		...
		temp.add(new TsoroCell(5 * size, 1 * size, size - 2, size - 2));

	
		temp.clear();
		// grid 1
		row.add(new TsoroCell(3 * size, 3 * size, size - 2, size - 2));
		temp.add(new TsoroCell(3 * size, 3 * size, size - 2, size - 2));
		this.grid.add(row);
		neighbors0.add(temp);
		neighbors2.add(temp);
		neighbors4.add(temp);
		temp.clear();
		// grid 2
		row.add(new TsoroCell(5 * size, 3 * size, size - 2, size - 2));
		temp.add(new TsoroCell(5 * size, 3 * size, size - 2, size - 2));
		this.grid.add(row);
		neighbors0.add(temp);
		neighbors2.add(temp);
		neighbors6.add(temp);
		temp.clear();
		// grid 3
		row.add(new TsoroCell(7 * size, 3 * size, size - 2, size - 2));
		temp.add(new TsoroCell(7 * size, 3 * size, size - 2, size - 2));
		this.grid.add(temp);
		neighbors1.add(temp);
		neighbors5.add(temp);
		temp.clear();
		// grid 4
		row.add(new TsoroCell(1 * size, 5 * size, size - 2, size - 2));
		temp.add(new TsoroCell(1 * size, 5 * size, size - 2, size - 2));
		this.grid.add(row);
		neighbors1.add(temp);
		neighbors5.add(temp);
		temp.clear();
		// grid 5
		row.add(new TsoroCell(5 * size, 5 * size, size - 2, size - 2));
		temp.add(new TsoroCell(5 * size, 5 * size, size - 2, size - 2));
		this.grid.add(row);
		neighbors2.add(temp);
		neighbors6.add(temp);
		neighbors4.add(temp);
		...
		// grid 6
		row.add(new TsoroCell(9 * size, 5 * size, size - 2, size - 2));
		temp.add(new TsoroCell(9 * size, 5 * size, size - 2, size - 2));
		this.grid.add(row);
		neighbors3.add(temp);
		neighbors5.add(temp);
		temp.clear();
